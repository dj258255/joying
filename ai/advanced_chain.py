...
{{{{
  ...
  "recommended_deposit": 500000,
  "rental_ratio": 0.03,
  "deposit_ratio": 0.5,
  "reasoning": "MacBook Air M1은 신품가 약 100만원이며, 새것 상태이므로 현재 가치는 100만원입니다. 전자기기이므로 하루 대여료는 3% 수준인 30,000원이 적절하고, 고가 전자기기이므로 보증금은 현재 가치의 50%인 500,000원을 권장합니다."
}}}}"""),
