...
#### SSAFY 13기 2학기 자율프로젝트 광주 2반 C202 RTS(RenTalShop) (25.10.10 ~ 25.11.20)
...
|                  메인 페이지 & 검색                  |
|:-----------------------------------------------:|
| ![메인 페이지 & 검색](/README_img/mainAndSearch.gif) |
...
|                     상품 등록                    |
|:----------------------------------------------------:|
| ![상품 등록](/README_img/productUpload.gif) |
...
|            상품 상세            |
|:------------------------------------:|
| ![상품 상세](/README_img/productDetail.gif) |
...
|                           대여 상세                            |
|:-------------------------------------------------------------:|
| ![대여 상세](/README_img/rentalDetail.gif) |
...
|                                          채팅 기반 거래                                          |
|:---------------------------------------------------------------------------------------:|
|                             ![채팅 기반 거래](/README_img/chating.gif)                              |
