...
""")
    ...
    async def classify_category(
        ...
        categories = """
**상위 카테고리와 하위 카테고리:**
- 창작: 카메라, 렌즈, 조명, 마이크, 악기 (기타/피아노/드럼 등 실제 음악 악기), 그래픽 태블릿, 오디오 인터페이스
- 공예: 3D프린터, 공예도구, 미술도구, 목공키트, 수공예 재료
- 오락: 콘솔 게임기 (닌텐도 스위치/PS5/Xbox 등), 보드게임, VR기기, 파티게임, 게이밍 액세서리
...
1. **게임 관련 (오락 카테고리)**
   - 닌텐도 스위치, PS5, Xbox, 스팀덱 → "오락" - "콘솔 게임기"
   - 게이밍 마우스, 게이밍 키보드, 게이밍 헤드셋 → "오락" - "게이밍 액세서리"
   - 게임기는 절대 악기가 아닙니다!

2. **음악 관련 구분**
   - 기타, 피아노, 드럼, 바이올린, 신디사이저 → "창작" - "악기" (실제 연주 악기만!)
   - 헤드폰, 이어폰, 블루투스 스피커 → "음악·영상 감상" (악기 아님!)
   - 마이크, 오디오 인터페이스 → "창작" (녹음/방송 장비)
