                ...
                <div className="lg:w-2/3 space-y-4">
                  ...
                  <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl">
                    ...
                    <div className="flex-1">
                      <h4 className="font-semibold text-gray-900">{rental.renter.username} 님에게 빌려줌</h4>
                      <p className="text-sm text-gray-600">{rental.renter.email}</p>
                    </div>
                    <div className="text-right">
                      <div className="text-sm text-gray-500">평점</div>
                      <div className="font-semibold text-blue-600">{rental.renter.rating}</div>
                    </div>
                  </div>
