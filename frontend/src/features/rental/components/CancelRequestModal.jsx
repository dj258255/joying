  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="거래 취소 신청">
      <div className="space-y-6 p-1">
        ...
        <div>
          ...
          <div className="flex gap-2 mb-3">
            <button
              ...
              className="flex-1 px-3 py-2 text-sm glass-button-ghost text-gray-900 rounded-lg transition-colors"
            >
              반반 분배
            </button>
            <button
              ...
              className="flex-1 px-3 py-2 text-sm bg-white/60 backdrop-blur-sm border border-white/30 text-gray-900 rounded-lg hover:bg-white/80 transition-colors"
            >
              대여자 전액
            </button>
            <button
          ...
          {/* 합계 확인 */}
          <div className={`flex items-center justify-between px-3 py-2 rounded-lg backdrop-blur-sm ${
            error ? 'bg-red-500/20 border border-red-400/50' : 'bg-green-500/20 border border-green-400/50'
          }`}>
            <span className="text-sm font-medium text-gray-900">분배 합계:</span>
            <span className={`text-sm font-bold ${error ? 'text-red-800' : 'text-green-800'}`}>
        ...
        {error && (
          <div className="bg-red-500/20 backdrop-blur-sm border border-red-400/50 rounded-lg p-3">
            <div className="flex items-start">
              <svg className="w-5 h-5 text-red-800 mt-0.5 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
        ...
        {/* 안내 메시지 */}
        <div className="bg-yellow-500/20 backdrop-blur-sm border border-yellow-400/50 rounded-lg p-3">
          <div className="flex items-start">
            <svg className="w-5 h-5 text-yellow-800 mt-0.5 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex-1 px-4 py-3 glass-button-ghost text-gray-900 rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            취소
          </button>
          <button
            ...
            className="flex-1 px-4 py-3 glass-button-danger text-white rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
