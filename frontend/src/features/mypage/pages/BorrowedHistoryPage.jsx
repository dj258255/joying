      ...
      <div className="p-6 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-4 flex flex-col">
            <h2 className="text-lg font-bold text-gray-900 mb-3">판매자 정보</h2>
            ...
            <div className="flex-1 flex flex-col justify-center">
              <div className="text-center mb-3">
                ...
                />
                <h3 className="text-base font-semibold text-gray-900 mb-1">{ownerUser?.nickname || ownerUser?.name || rental.owner?.nickname || rental.owner?.name} 님</h3>
          ...
          {/* 중간 오른쪽: 판매자가 남긴 리뷰 */}
          <div className="bg-white rounded-2xl shadow-lg p-4">
            <h2 className="text-lg font-bold text-gray-900 mb-3">판매자가 남긴 리뷰</h2>
            ...
            {loadingReviews ? (
              ...
              <div>
                ...
                {ownerReview.title && (
                  <h4 className="font-semibold text-gray-900 mb-1.5 text-sm">{ownerReview.title}</h4>
                )}
                <p className="text-gray-700 mb-2 text-sm">"{ownerReview.content}"</p>
                {/* 리뷰 이미지 표시 */}
              ...
              <div className="text-center py-6">
                <p className="text-gray-600 text-sm">판매자가 아직 리뷰를 작성하지 않았습니다.</p>
              </div>
            )}
          </div>
