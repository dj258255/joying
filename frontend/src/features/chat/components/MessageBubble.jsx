    ...
    return (
      <div id={id ? `message-${id}` : undefined} className={`flex ${isOwn ? 'justify-end' : 'justify-start'} mb-3`}>
        <div className="max-w-sm">
          <div 
            className="bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-2xl p-3"
          >
      ...
      <div id={id ? `message-${id}` : undefined} className={`flex ${isOwn ? 'justify-end' : 'justify-start'} mb-3`}>
        ...
        {isOwn && showReadIndicator && (
          <div className="flex items-end mr-1">
            <span className="text-blue-500 text-xs animate-fade-in">읽음</span>
          </div>
        )}
